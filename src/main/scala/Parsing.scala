        ...
        lines map { line =>
          new Job {
            ...
            object res extends ResourceUsage {
              ...
              lazy val mem     = parts(37).replaceAll(",", ".").toDouble
              lazy val io      = parts(38).replaceAll(",", ".").toDouble
              lazy val iow     = parts(40).replaceAll(",", ".").toDouble
              lazy val maxvmem = parts(42).replaceAll(",", ".").toLong
            }
        ...
        lines map { line =>
          new Job {
            ...
            object res extends ResourceUsage {
              ...
              lazy val io      = parts(38).replaceAll(",", ".").toDouble
              lazy val iow     = parts(40).replaceAll(",", ".").toDouble
              lazy val maxvmem = parts(42).replaceAll(",", ".").toLong * 1000
            }
        ...
        lines map { line =>
          new Job {
            ...
            object res extends ResourceUsage {
              ...
              lazy val io      = parts(38).replaceAll(",", ".").toDouble
              lazy val iow     = parts(40).replaceAll(",", ".").toDouble
              lazy val maxvmem = (parts(42).replaceAll(",", ".").toDouble * 1000).round
            }
            ...
            object time extends Time {
              lazy val submission = Time.seconds(parts(8))
              lazy val start = Time.seconds(parts(9))
              lazy val end = Time.seconds(parts(10))
            }
